                           ...
                           implements Deque<E>, Cloneable, Serializable
{
     ...
     * of the deque (via addLast(E), cache(E), or push(E)).
     */
    transient int tail;
    ...
    /**
     * Remove from head with count
     * @param count element count to remove from head
     */
